...
public class Game extends Thread{
    ...
    public Game(Integer cols, Integer rows, Integer inner_wall_count, Integer idA, Bot botA, Integer idB, Bot botB){
        this.rows = rows;
        this.cols = cols;
    ...
    private String getInput(Player player) {         // 将当前的局面信息编码成字符串
        // 地图 # 起始sx # 起始sy # 操作 # 对手sx # 对手sy # 对手操作
        Player me, you;
    ...
    private void updateUserRating(Player player, Integer rating) {    // 更新天体积分
        // 先取出玩家
